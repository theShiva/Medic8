-- 
--  POCO Generator
--  Source: https://gist.githubusercontent.com/evgeny-myasishchev/8711676/raw/58a7003cc84aeedb57517facab488ac7e24f07c0/generate_dto.sql
--  Instructions: Replace the values for the input arguments before running script to generate POCO from table.
-- 
DECLARE @tableName NVARCHAR(MAX), @schemaName NVARCHAR(MAX), @className NVARCHAR(MAX)
 
--------------- Input arguments ---------------
SET @tableName = 'MemberDiagnosis'
SET @schemaName = 'dbo'
SET @className = 'MemberDiagnosis'
--------------- Input arguments end -----------
